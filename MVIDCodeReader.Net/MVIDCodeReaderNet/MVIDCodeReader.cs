...
{
	/// <summary>
	/// ch:图像数据回调 | en:Image data callback
	/// </summary>
	...
	/// </summary>
	/// <param name="nMsgType">ch:异常回调类型 | en:Exception message</param>
	/// <param name="pUser">ch:用户自定义变量 | en:User defined variable</param>
	public delegate void cbExceptiondelegate(uint nMsgType, IntPtr pUser);

	/// <summary>
	/// ch:预处理图像数据回调 | en:Pretreatment image data callback
	/// </summary>
	/// <param name="pstPreOutput">ch:预处理输出参数指针 | en:Output image parameters structure</param>
	/// <param name="pstProcInput">ch:预处理输入参数指针，由SDK内部分配 | en:Intput image parameters structure</param>
	/// <param name="pUser">ch:用户自定义变量 | en:User defined variable</param>
	...
	/// </summary>
	/// <param name="pEventInfo">ch:事件回调参数结构体 | en:Exception callBack function structure</param>
	/// <param name="pUser">ch:用户自定义变量 | en:User defined variable</param>
	...
	public struct MVID_IMAGE_INFO
	{
		...
		/// <summary>ch: 帧触发号 | en: frame Trigger Counting 32 bits</summary>
		public uint nFrameCounter;

		/// <summary>  ch:触发计数 | en:Trigger Counting  32 bits</summary>
		public uint nTriggerIndex;

		/// <summary> 主机时间戳低位 | en:host Timestamp 64bits</summary>
		public ulong nHostTimeStamp;

		/// <summary>  ch:本张图的解码时间 | en:DecodingTime</summary>
		public uint nDecodingTime;
	...
	public struct MVID_CODE_INFO
	{
		...
		/// <summary>ch:估计ppm | en: ppm</summary>
		public int nPPM;
	...
	/// <summary>ch:条码信息Ex | en:Code information Ex</summary>
	...
	/// <summary>ch:条码信息列表Ex | en:Code information list Ex</summary>
	...
	/// <summary>ch:输出信息Ex | en:Output information Ex</summary>
	...
	/// <summary>ch:运行参数Ex | en:Process parameter Ex</summary>
	...
	/// <summary>ch:全匹配的一种信息结构体 | en:A fully matched information structure</summary>
	public struct MVID_ALL_MATCH_INFO
	{
		/// <summary>ch:需要输出的信息类型e.g. MVID_MATCH_TYPE_NET_DETECT | en:Information type need to output ,e.g. MVID_MATCH_TYPE_NET_DETECT</summary>
		public uint nType;

		/// <summary>ch:输出的信息缓存，由调用者分配 | en:Output information cache, which is allocated by the caller</summary>
		public IntPtr pInfo;

		/// <summary>ch:信息缓存的大小  | en:Information cache size</summary>
		public uint nInfoSize;
	}

	/// <summary>ch:网络流量和丢包信息反馈结构体，对应类型为 MVID_MATCH_TYPE_NET_DETECT
	/// en:Network traffic and packet loss feedback structure, the corresponding type is MVID_MATCH_TYPE_NET_DETECT</summary>
	public struct MVID_MATCH_INFO_NET_DETECT
	{
		/// <summary>ch:已接收数据大小  [统计StartGrabbing和StopGrabbing之间的数据量] | en:Received data size</summary>
		public long nReviceDataSize;

		/// <summary>ch:丢失的包数量 | en:Number of packets lost</summary>
		public long nLostPacketCount;

		/// <summary>ch:丢帧数量 | en:Number of frames lost</summary>
		public uint nLostFrameCount;

		/// <summary>ch:保留 | en:Reserved</summary>
		public uint nNetRecvFrameCount;

		/// <summary>ch:请求重发包数 </summary>
		public long nRequestResendPacketCount;

		/// <summary>ch:重发包数</summary>
		public long nResendPacketCount;
	}

	/// <summary>ch:host收到从u3v设备端的总字节数，对应类型为 MVID_MATCH_TYPE_USB_DETECT | 
	/// en:The total number of bytes host received from the u3v device side, the corresponding type is MV_MATCH_TYPE_USB_DETECT</summary>
	public struct MVID_MATCH_INFO_USB_DETECT
	{
		/// <summary>ch:已接收数据大小 [统计OpenDevicce和CloseDevice之间的数据量]| en:Received data size</summary>
		public long nReviceDataSize;

		/// <summary>ch:已收到的帧数 | en:Number of frames received</summary>
		public uint nRevicedFrameCount;

		/// <summary>ch:错误帧数 | en:Number of error frames</summary>
	...
	/// <summary>ch:带宽不足 | en:Insufficient bandwidth</summary>
	...
	/// <summary>ch:网络流量和丢包信息 | en:Network traffic and packet loss information</summary>
	public const int MVID_MATCH_TYPE_NET_DETECT = 1;

	/// <summary>ch:host接收到来自U3V设备的字节总数 | en:The total number of bytes host received from U3V device</summary>
	public const int MVID_MATCH_TYPE_USB_DETECT = 2;
	...
	/// <remarks>ch:pstrVersion包含SDK，一维码，二维码版本号，以'_'分隔，如"1.2.0.1_3.6.2_2.2.5" | en:pstrVersion contains the SDK, BCR, and TDCR version numbers, separation with '_', such as "1.2.0.1_3.6.2_2.2.5"</remarks>
	public static int MVID_CR_GetVersion_NET(IntPtr pstrVersion)
	{
		return CMVIDCRef.MVID_CR_GetVersion(pstrVersion);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_EnumDevices(ref pstCamList);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_EnumDevicesByCfg(ref pstCamList);
	}
	...
	public int MVID_CR_CreateHandle_NET(uint nCodeAbility)
	{
		...
		return CMVIDCRef.MVID_CR_CreateHandle(ref handle, nCodeAbility);
	}
	...
	{
		int nRet = CMVIDCRef.MVID_CR_DestroyHandle(handle);
		if (nRet == 0)
		{
			handle = IntPtr.Zero;
		}
	...
	{
		return CMVIDCRef.MVID_CR_Algorithm_SetIntValue(handle, strParamKeyName, nValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_Algorithm_GetIntValue(handle, strParamKeyName, ref pnValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_Algorithm_SetFloatValue(handle, strParamKeyName, fValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_Algorithm_GetFloatValue(handle, strParamKeyName, ref pfValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_Algorithm_SetStringValue(handle, strParamKeyName, strValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_Algorithm_GetStringValue(handle, strParamKeyName, ref strValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_Process(handle, pstParam, nCodeAbility);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_BindDevice(handle, pstCamInfo);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_BindDeviceByIP(handle, chCurrentIp, chNetExport);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_BindDeviceBySerialNumber(handle, chSerialNumber);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_RegisterImageCallBack(handle, cbOutput, pUser);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_RegisterImageBufferCallBack(handle, cbOutput, pUser);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_RegisterAllEventCallBack(handle, cbEvent, pUser);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_StartGrabbing(handle);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_StopGrabbing(handle);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_GetOneFrameTimeout(handle, pFrameInfo, nMsec);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_GetImageBuffer(handle, ref pFrameInfo, nMsec);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_SetIntValue(handle, strKey, nValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_GetIntValue(handle, strKey, ref pIntValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_SetEnumValue(handle, strKey, nValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_SetEnumValueByString(handle, strKey, sValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_GetEnumValue(handle, strKey, ref pEnumValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_SetFloatValue(handle, strKey, fValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_GetFloatValue(handle, strKey, ref pFloatValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_SetStringValue(handle, strKey, sValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_GetStringValue(handle, strKey, ref pStringValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_SetBoolValue(handle, strKey, bValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_GetBoolValue(handle, strKey, ref pBoolValue);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_SetCommandValue(handle, strKey);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_SetImageNodeNum(handle, nNum);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_SetImageOutPutMode(handle, enImageOutPutMode);
	}
	...
	{
		return CMVIDCRef.MVID_CR_CAM_RegisterPreImageCallBack(handle, cbPreOutput, pUser);
	}
	...
	{
		return CMVIDCRef.MVID_CR_RegisterExceptionCallBack(handle, cbException, pUser);
	}
	...
	/// <param name="nJpgQuality">ch:JPG压缩质量, 若目标转换类型为BMP则该参数无效 | en:Jpg quality, no use for Bmp image</param>
	/// <returns>ch:成功, 返回MVID_CR_OK; 错误, 返回错误码 | en:Success, return MVID_CR_OK. Failure, return error code</returns>
	...
	{
		return CMVIDCRef.MVID_CR_SaveImage(handle, ref pstInputImage, enImageType, ref pstOutputImage, nJpgQuality);
	}

	/// <summary>
	/// ch:读取图片文件，转换为MVID_IMAGE_MONO8格式，可用于MVID_CR_Process | en:Read image file, convert to MVID_IMAGE_MONO8 format, can be used for MVID_CR_Process
	/// </summary>
	/// <param name="pFilePath">ch:输入图片文件路径 | en:Input image parameters structure</param>
	/// <param name="pstImageParam">ch:输出图片参数结构体 | en:OutPut image parameters structure</param>
	/// <returns>ch:成功, 返回MVID_CR_OK; 错误, 返回错误码 | en:Success, return MVID_CR_OK. Failure, return error code</returns>
	/// <remarks>
	/// ch:支持Raw、Bmp、Jpeg格式图片，Raw图片需要传入宽、高及像素格式(Mono8/BGR24) | en:Support Raw, Bmp, Jpeg format image, Raw image require incoming width, height, and pixel format(Mono8/BGR24)
	/// </remarks>
	public int MVID_CR_GetImageFileData_NET(string pFilePath, IntPtr pstImageParam)
	{
		return CMVIDCRef.MVID_CR_GetImageFileData(handle, pFilePath, pstImageParam);
	}
	...
	{
		return CMVIDCRef.MVID_CR_RuleLoad(handle, pFileName);
	}
	...
	{
		return CMVIDCRef.MVID_CR_ScriptLoad(handle, pFilePath, pFuncName);
	}

	/// <summary>
	/// ch:获取各种类型的信息 | en:Get various type of information
	/// </summary>
	/// <param name="pstInfo">ch:返回给调用者有关设备各种类型的信息结构体指针 | en:Structure pointer of various type of information</param>
	/// <returns></returns>
	public int MVID_CR_CAM_GetAllMatchInfo_NET(ref MVID_ALL_MATCH_INFO pstInfo)
	{
		return CMVIDCRef.MVID_CR_CAM_GetAllMatchInfo(handle, ref pstInfo);
	}
